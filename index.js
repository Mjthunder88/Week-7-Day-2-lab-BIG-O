...
// ANSWER:  numbers[3] 
// n(1) because we're already know what we are looking for. 
// So you can always improve the RUNTIME but you can't improve the RUNTIME complexity if its already CONSTANT
...
// ANSWER: No because of the goal you're trying to achive
...
// ANSWER: Because the RoundTwo function will have a differn't sized letter object for each string that is sent into the function. So it could either contain all of the letters of the alphabet or only 5.
//  Where as the first one is just changing the count of the letters. No data is being added at all. 
